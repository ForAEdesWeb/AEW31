...
document.getElementById(a+'_star_'+j).src="components/com_formmaker/images/star_"+document.getElementById(a+'_star_colorform_id_temp').value+".png";
...
document.getElementById(a+'_star_'+j).src="components/com_formmaker/images/star.png";
...
document.getElementById(a+'_star_'+k).src="components/com_formmaker/images/star.png";
...
document.getElementById(a+'_star_'+j).src="components/com_formmaker/images/star_yellow.png";
...
document.getElementById('submission_'+a).value=star_amount+'***'+(id+1)+"***star_rating***";
